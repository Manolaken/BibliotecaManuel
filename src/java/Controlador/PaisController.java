...
public class PaisController implements Serializable {
    ...
    private List<LibroPremio> lista;

    public List<LibroPremio> getLista() {
        return lista;
    }

    public void setLista(List<LibroPremio> lista) {
        this.lista = lista;
    }
    ...
    public static class PaisControllerConverter implements Converter {
        ...
        public void loadPremiosPais(){
        this.setLista(ejbFacade.premioPorPais(current));        
    }
