...
public class LibroController implements Serializable {
    ...
    private Repositorios.PremioFacade prFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;
    private Autor autor;
    private List<Libro> lista; // Lista de libros
    private DataModel dataModelLibros;
    private Pais pais;
    private Premio premio;
    private List<Premio> lPremios;

    public List<Premio> getlPremios() {
        return lPremios;
    }
    public void setlPremios(List<Premio> lPremios) {
        this.lPremios = lPremios;
    }
    ...
    public void loadPremiosAlLibroPais(){
        this.setlPremios(prFacade.premiosLibroPais(pais));
    }
